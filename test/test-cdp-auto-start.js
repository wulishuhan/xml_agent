        ...
        try {
            ...
            provider
                ...
                .then(function () {
                    ...
                    console.log(
                        " ✅ " + providerName + " connected successfully in " + elapsed + "ms"
                    );
...
function runTests() {
    ...
    return checkPort(TEST_CDP_PORT)
        .then(function (initialPortOpen) {
            if (initialPortOpen) {
        ...
        .then(function (reuseResult) {
            results.push({
                provider: "chatgpt-reuse",
                success: reuseResult.success,
                elapsed: reuseResult.elapsed,
